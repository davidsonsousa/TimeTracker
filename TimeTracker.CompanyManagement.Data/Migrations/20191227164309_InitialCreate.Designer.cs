...
namespace TimeTracker.CompanyManagement.Data.Migrations
{
    ...
    [Migration("20191227164309_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTracker.CompanyManagement.Core.Models.BranchTeam", b =>
                {
            ...
            modelBuilder.Entity("TimeTracker.CompanyManagement.Core.Models.TeamProject", b =>
                {
                    b.Property<int>("TeamId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeTracker.CompanyManagement.Core.Models.BranchTeam", b =>
                {
                    b.HasOne("TimeTracker.CompanyManagement.Core.Models.Branch", "Branch")
                        .WithMany("BranchTeams")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TimeTracker.CompanyManagement.Core.Models.Team", "Team")
                        .WithMany("BranchTeams")
            ...
            modelBuilder.Entity("TimeTracker.CompanyManagement.Core.Models.TeamProject", b =>
                {
                    b.HasOne("TimeTracker.CompanyManagement.Core.Models.Project", "Project")
